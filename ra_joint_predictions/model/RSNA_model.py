...
def complex_joint_finetune_model(config, no_joint_types = 10, weights = "weights/NIH_new_pretrain_model_100"):
    NIH_model = NIH.create_complex_joint_multioutput(config)
