...
def train_hands():
    ...
    combined_model_hands = combined_sc1_model.get_hand_model("/mnt/iusers01/jw01/mdefscs4/ra_challenge/RA_challenge/michael_dev/RA2_alpine_lads/trained_models/v3/joints_narrowing_reg_old_pretrain_adam_shuffle.h5",
    ...
    combined_sc1_train.train_SC1_model(configuration,combined_model_hands,"SC1_v3A_hand_narrowing_mae_sgd_cosine",ds,val_ds,epochs_before = 11, epochs_after = 101)
