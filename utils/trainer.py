...
# pretrain model for joint recognition on faces
# pretrain model for joint classification - pretrain on chest, then pretrain on joints from RSNA bone age to predict age and sex

# get weights from pretrains

# train landmarks on joints

# predict landmarks

# rescale landmarks to image size?
