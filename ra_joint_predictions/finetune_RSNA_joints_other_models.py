...
#     finetune_model(model,f"{name}_RSNA_joint_v3",joint_dataset,joint_val_dataset, epochs_before = 10, epochs_after = 76, n_outputs = 13)
...
# configuration = Config()
name = "densent_imagenet_with_NIH_nopad_new_shape"
...
configuration = Config()
name = "Xception_imagenet_with_NIH_nopad_new_shape"
