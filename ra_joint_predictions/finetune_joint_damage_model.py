...
from train.train_joints_damage import finetune_minority_model
...
if __name__ == '__main__':
    ...
    trained_model, hist_df = finetune_minority_model(config, model_name, pretrained_model + '.h5', joint_type, dmg_type, do_validation = do_validation, model_type = model_type)
