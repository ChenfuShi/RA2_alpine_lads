...
def train_feet():
    ...
    combined_sc1_train.train_SC1_model(configuration,combined_model_feet,"SC1_v3A_feet_erosion_mae_sgd_cosine",ds,val_ds,epochs_before = 11, epochs_after = 101)


def train_hands():
    hand_extractor = get_joint_extractor("H", True)
    combined_model_hands = combined_sc1_model.get_hand_model("/mnt/iusers01/jw01/mdefscs4/ra_challenge/RA_challenge/michael_dev/RA2_alpine_lads/trained_models/v3/joints_erosion_reg_old_pretrain_adam_shuffle.h5",
    ...
    combined_sc1_train.train_SC1_model(configuration,combined_model_hands,"SC1_v3A_hand_erosion_mae_sgd_cosine",ds,val_ds,epochs_before = 11, epochs_after = 101)
