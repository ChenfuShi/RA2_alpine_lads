...
from model.NIH_model import create_rewritten_complex_joint_multioutput,create_VGG_multioutput,create_resnet_multioutput,create_bigger_kernel_multioutput,create_densenet_multioutput
...
if __name__ == '__main__':
    ...
    for model_constr,name in zip([create_rewritten_complex_joint_multioutput,create_VGG_multioutput,create_resnet_multioutput,create_bigger_kernel_multioutput,create_densenet_multioutput],["NIH_rewritten","NIH_VGG","NIH_resnet_moredense","NIH_bigger_kernel","NIH_densenet"]):
