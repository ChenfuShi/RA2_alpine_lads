...
def train_feet():
    ...
    combined_model_feet = combined_sc1_model.get_feet_model("/mnt/iusers01/jw01/mdefscs4/ra_challenge/RA_challenge/michael_dev/RA2_alpine_lads/trained_models/feet_narrowing/v6/feet_narrowing_joint_damage_model_complex_rewritten_64bs_100steps_300epochs_adamW_3e4_1e6_fullwd_fully_balanced.h5")
    ...
    combined_sc1_train.train_SC1_model(configuration,combined_model_feet,"SC1_v6_feet_narrowing_mae_adamw3_0.60_100_steps",ds,val_ds,epochs_before = 11, epochs_after = 101)
    ...
    combined_sc1_train.train_SC1_model(configuration,combined_model_feet,"SC1_v6_feet_erosion_mae_adamw3_0.60_100_steps",ds,val_ds,epochs_before = 11, epochs_after = 101)
...
def train_hands():
    ...
    combined_model_hands = combined_sc1_model.get_hand_model("/mnt/iusers01/jw01/mdefscs4/ra_challenge/RA_challenge/michael_dev/RA2_alpine_lads/trained_models/hands_narrowing/v6/hands_narrowing_joint_damage_model_complex_rewritten_64bs_120steps_300epochs_adamW_3e4_1e6_fullwd_fully_balanced.h5",
                                                            "/mnt/iusers01/jw01/mdefscs4/ra_challenge/RA_challenge/michael_dev/RA2_alpine_lads/trained_models/wrists/v6/wrists_narrowing_joint_damage_model_complex_rewritten_64bs_12steps_300epochs_adamW_3e4_1e6_fullwd.h5")
    ...
    combined_sc1_train.train_SC1_model(configuration,combined_model_hands,"SC1_v6_hand_narrowing_mae_adamw3_0.60_100_steps",ds,val_ds,epochs_before = 11, epochs_after = 101)
    ...
    combined_model_hands = combined_sc1_model.get_hand_model("/mnt/iusers01/jw01/mdefscs4/ra_challenge/RA_challenge/michael_dev/RA2_alpine_lads/trained_models/hands_erosion/v6/hands_erosion_joint_damage_model_complex_rewritten_64bs_120steps_300epochs_adamW_3e4_1e6_fullwd_balanced.h5",
                                                            "/mnt/iusers01/jw01/mdefscs4/ra_challenge/RA_challenge/michael_dev/RA2_alpine_lads/trained_models/wrists/v6/wrists_erosion_joint_damage_model_complex_rewritten_64bs_12steps_300epochs_adamW_3e4_1e6_fullwd.h5",
                                                            erosion_flag = True)
    ...
    combined_sc1_train.train_SC1_model(configuration,combined_model_hands,"SC1_v6_hand_erosion_mae_adamw3_0.60_100_steps",ds,val_ds,epochs_before = 11, epochs_after = 101)
