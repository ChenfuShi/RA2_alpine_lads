...
## joints
joint_dataset, joint_val_dataset = rsna_joint_dataset(configuration, pad_resize = False, joint_scale = 6).create_rsna_joints_dataset(val_split = True, include_wrist_joints = True)
